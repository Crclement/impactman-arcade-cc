<template>
  <div class="hero" :class="{ 'is-active': isActive }">
    <div class="impact-arcade-wrapper">
      <img class="arcade" src="/images/arcade-right.svg" />
      <div class="arcade-text">
        <img v-if="isMobile" src="/images/mobile-impact-arcade.png" />
        <img v-else src="/images/impact-arcade.png" />
        <h3>Launching 2023</h3>
      </div>
      <img class="arcade" src="/images/arcade-left.svg" />
    </div>
    <div class="form-container">
      <EmailForm />
    </div>
  </div>
  <img src="/images/gradient.jpeg" class="gradient" />
</template>
